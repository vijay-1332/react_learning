export default function Card(props){
    return(
        <div className="flex">
            <img alt="location" src={`/images/travel_journal/${props.image}`} className="h-[168px] w-[125px]"></img>
            <div className="flex flex-col ml-5">
            <div className="flex items-center mt-4">
                <img alt="map-icon" src="/images/travel_journal/map-pin.png" className="h-[10px] w-[7px] mr-1"></img>
